  ...
  <div class="page-css">
    <div class="outer-container">
      ...
      <div class="inner-container">
        ...
        <div class="calc-rows" @click="clearDisplay()">
          <div class="calc-cols-second-row-col"  :style="{textAlign:'center',width: '75%',padding:'15px'}">
            <div class="button-container">
              <p >clear</p>
            </div>
          </div> 
          <div class="calc-cols1"  @click="handleOperator('/')" :style="{paddingLeft:'5px', width: '25%',border : 'red 1px solid',textAlign:'center',paddingTop:'15px'}" >
            <div class="button-container">
              <p class="button">/</p>
            </div>
          </div>
    ...
    <div>
      <div class="clock-header">
        ...
        <span :style="{'font-size':'40px','margin-left':'10px'}">Digital Clock</span>
      </div>
        ...
        <div >
          ...
          <div class="clock-element">
            <div class="clock-content">
              <div :style="{'white-space': 'pre'}">{{ displayClockContent }}</div>
